...
public class SelectDeviceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pairedDevices.size() > 0) {
            displayPairedDevice(pairedDevices);
        } else {
            displayMessage();
        }
    ...
    private void displayPairedDevice(Set<BluetoothDevice> pairedDevices) {
        List<Object> deviceList = new ArrayList<>();

        getNameAndAddressForPairedDevice(pairedDevices, deviceList);
    ...
    private void getNameAndAddressForPairedDevice(Set<BluetoothDevice> pairedDevices, List<Object> deviceList) {
